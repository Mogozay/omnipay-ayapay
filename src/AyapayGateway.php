...
namespace Ayapay\Mogozay;

use Omnipay\Common\AbstractGateway;
use Ayapay\Mogozay\Message\CompletePurchaseRequest;
use Ayapay\Mogozay\Message\PurchaseRequest;
 ...
 */
class AyapayGateway extends AbstractGateway
{
    ...
    **/
    ...
    {
        return $this->createRequest('\Ayapay\Mogozay\Message\PurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Ayapay\Mogozay\Message\CompletePurchaseRequest', $parameters);
    }
}
